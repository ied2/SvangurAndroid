...
public class GmapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private Activity activity = Map.activity;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Log.d("IED", Info.latitude + " " + Info.longitude);
...
//                String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?daddr=%f,%f(%s)", latitude, longitude, "Where the party is at");
                String uri = String.format(Locale.ENGLISH, "http://maps.google.com/maps?daddr=%f,%f", Info.latitude, Info.longitude);
...
//        mMap.getUiSettings().setAllGesturesEnabled(true);
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(
                new LatLng(Info.latitude, Info.longitude), 14));

        Marker marker = mMap.addMarker(new MarkerOptions()
//                .icon(BitmapDescriptorFactory.fromResource(R.drawable.maps_icon))
                .title(Info.name)
//                .snippet(Double.toString(Info.distance))
...
//        try {
//        item = (JSONObject)restaurants.get(i);
//
//        String name = item.getString("name");
//        double latitude = Double.parseDouble(item.getString("horizontal"));
//        double longitude = Double.parseDouble(item.getString("vertical"));
//
//        Marker marker = mMap.addMarker(new MarkerOptions()
//        .title(name)
//        .anchor(0.0f, 1.0f) // Anchors the marker on the bottom left
